...
}();"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("basic",(()=>{"use strict";return E=>({name:"BASIC",
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("moonscript",(()=>{"use strict";return e=>{const n={
...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(t).concat(_)}}})());hljs.registerLanguage("dos",(()=>{"use strict";return e=>{
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("java",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("gml",(()=>{"use strict";return e=>({name:"GML",
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("angelscript",(()=>{"use strict";return e=>{var n={
className:"built_in",
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("glsl",(()=>{"use strict";return e=>({name:"GLSL",
keywords:{
...
className:"meta",begin:"#",end:"$"}]})})());hljs.registerLanguage("perl",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("haxe",(()=>{"use strict";return e=>({name:"Haxe",
aliases:["hx"],keywords:{
...
illegal:"\\S",contains:[e.TITLE_MODE]}],illegal:/<\//})})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("llvm",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("d",(()=>{"use strict";return e=>{const a={
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
